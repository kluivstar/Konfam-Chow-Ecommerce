    ...
    <section className='bg-gray-200'>
      <div className={`container flex flex-col sm:gap-20 sm:flex-col md:flex-col justify-between lg:flex-col xl:flex-row ${style.paddingX} ${style.paddingY}`}>
        ...
        <div className='sm:pt-28'>
            <div  className={`hero-text ${style.heading} pt-0 sm:pt-18 m-auto text-left sm:text-left xlm:leading-16`}>
            ...
            <button class='hidden xl:block bg-slate-800  text-white rounded px-5 py-2 hover:bg-slate-600 font-poppins text-[26px] mt-5'>Explore

            </button>
        </div>

        {/* Hero Img */}
        <div className={`hero-text ${style.heading}  ${style.paddingY} `}>
