...
const Hero = () => {
  return (
    <section className='bg-gray-200'>
      <div className={`container flex flex-col sm:flex-row md:flex-row justify-between lg:flex-row ${style.paddingX} ${style.paddingY}`}>
        {/*Hero Text */}
        <div className={`hero-text ${style.heading} pt-0 sm:pt-28 leading-2`}>
        ...
        <div className={`hero-text ${style.heading}  ${style.paddingY} sm:px-16 `}>
            <img className='w-1/1 mb-10 relative z-[5] sm:mb-0' src={heroImg} alt=""/>
            
            {/* Gradient */}
            <div className='absolute z-[0] w-[50%] h-[50%] right-10 bottom-0 blue__gradient'>
